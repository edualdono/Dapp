...
class Tokens extends Component {
  ...
  _balanceTokens = async () => {
    try {
      ...
      //en caso de no guardar la direccion en el constructor las siguiente lineas son una forma de guardarla
      //const accounts = await web3.eth.getAccounts()
  ...
  _balanceTokensSC = async () => {
    try {
      console.log("Balance de tokens del Smart Contracrt en ejecucion ...")
  ...
  _devolverTokens = async (_numTokens) => {
    try{
      ...
      Swal.fire({
        icon: 'success',
        title: '¡Devolucion de tokens realizada!',
        width: 800,
        padding: '3em',
          ...
          <div className="row">
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto">
                ...
                <h3>Devolucion de TOKENS ERC-20</h3>
                <form onSubmit={(event) => {
                  event.preventDefault()
