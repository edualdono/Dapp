...
class Loteria extends Component {
    ...
    _comprarBoletos = async (_numBoletos) => {
        try {
            ...
            Swal.fire({
                icon: 'success',
                title: 'Compra de boletos exitosa',
                width: 800,
                padding: '3em',
    ...
    _tusBoletos = async () => {
        try{
            console.log("Ver tus boletos en ejecucion ...")
                    ...
                    <div className="row">
                        <main role="main" className="col-lg-12 d-flex text-center">
                            <div className="content mr-auto ml-auto">
                                ...
                                <h1> Gestion de la loteria con ERC-20 y ERC-721</h1>
                                <h3>Compra de boletos</h3>
                                <form onSubmit={(event) => {
                                    event.preventDefault()
                                    const cantidad = this._numBoletos.value
                                    this._comprarBoletos(cantidad)
                                }}>
